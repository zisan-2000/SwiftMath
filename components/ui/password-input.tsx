...
/**
 * Password field with a built-in show/hide toggle. Forwards every native input
 * prop to the underlying <Input>; the trailing eye button flips the field
 * between `password` and `text` so users can verify what they typed.
 */
