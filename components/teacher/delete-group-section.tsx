...
import { deleteGroupAction } from "@/app/teacher/groups/[groupId]/actions";
...
/**
 * Destructive action to delete an empty group. Hidden when students remain;
 * the page passes `studentCount` so we can show a hint instead.
 */
